    ...
    <div className="min-h-screen -mx-4">
      <div className="relative w-full">
        <div className="absolute bg-black left-8 top-2/3 -translate-y-1/2 z-10 border-l-2 border-l-red-600 max-w-[90%] md:max-w-[70%]">
          <Link href="https://challonge.com/n1h3cvgn" className="flex flex-col max-w-[400px]">
            <div className="text-xl lg:text-2xl xl:text-3xl font-black">
            ...
            <div className="text-white text-lg p-4 pt-0">
              Register <span className="text-teal-400 hover:underline">here</span> for a chance to earn the <span className="italic text-amber-400">&apos;Queen of Hueco Mundo&apos;</span> and{" "}
              <span className="italic text-amber-400">&apos;Squad 8 Lieutenant&apos;</span> Badges!
            </div>
          </Link>
        </div>
