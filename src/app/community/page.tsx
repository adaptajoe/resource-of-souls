...
export default function Community() {
  return (
    <div className="text-black dark:text-white">
      <div className="flex flex-col items-center w-full py-2 text-base bg-gray-200 dark:bg-black justify-center px-4 md:text-xl border-b-2 border-b-black dark:border-b-gray-400 font-bebasFont">
        ...
        <p className="border-l-8 border-l-red-600 border-r-8 border-r-teal-600 dark:border-r-teal-400 text-center px-4">
          Have a Tournament that you&apos;d like featured? Message one of our Staff credited in the Footer, or use the form on the Community Leaderboard...!
        </p>
      </div>
      <div className="border-b-2 border-black dark:border-gray-400 relative">
        ...
        <Image
          ...
          width={300}
          alt=""
          className="max-h-[600px] sepia w-full object-cover object-top-center"
          style={{
            objectFit: "cover",
        ...
        <div className="bg-black absolute flex-col bottom-12 left-12 p-4 rounded-xl border-2 border-gray-400 hidden sm:flex">
          <div className="border-l-8 border-l-red-600 max-w-96 ">
            <p className="font-bebasFont tracking-wider text-4xl pl-4 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <div className="border-r-8 border-teal-600 dark:border-teal-400 pr-4 space-y-4 px-6">
              ...
              <p>
                <Link className="px-4 py-2 w-fit font-bebasFont text-xl text-white rounded bg-gray-700 hover:bg-red-600 hover:text-black transition-colors" href={"/community/community-leaderboard"}>
