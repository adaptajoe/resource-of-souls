...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} min-h-screen content-wrapper`}>
        <ThemeProvider>
          <div className="bg-white dark:bg-black w-full h-[125px] border-b-2 border-black dark:border-gray-400 py-2 px-12 z-50 hidden lg:flex flex-row items-center space-x-2 text-xs lg:text-sm xl:text-xl font-bebasFont text-white">
            ...
            <Link href="/">
              <Image
                ...
                className="border-2 border-black dark:border-black hover:border-teal-600 dark:hover:border-red-600 transition-colors mr-4 min-w-[150px] invert dark:invert-0"
                priority
              />
            </Link>
          ...
          <div className="bg-white dark:bg-black w-full h-[125px] border-b-2 border-gray-400 py-2 px-4 md:px-12 z-50 flex lg:hidden flex-row items-center space-x-2 text-xs lg:text-sm xl:text-xl font-bebasFont text-black dark:text-white justify-between md:justify-normal">
            <ThemeToggle />
            <Link href="/">
              <Image
                src={`/assets/site-assets/site-logo.png`}
          ...
          <div>{children}</div>
          <footer className="px-4 md:px-12 py-3 bg-white dark:bg-black border-t-2 border-gray-400 grid grid-cols-1 lg:grid-cols-2 text-gray-500 italic text-[8px] md:text-xs justify-center lg:justify-between">
            <div>
              <Link href="/changelog" className="text-xl font-bold text-teal-600 dark:text-teal-400 hover:underline">
                Site Version: v1.1.5.
              </Link>
              ...
              <p>
                Creator &amp; Competitive moderation by Discord user <span className="text-red-800 font-black">@mysticshinigamigt</span>.
              </p>
              <p>
                Character Data &amp; Stat collection by Discord user<span className="text-gray-400 font-black">@goldmine_shippuden</span>.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                株式会社バンダイナムコエンターテインメント ), ©Tamsoft Corporation ( 株式会社タムソフト ), ©TV Tokyo ( 株式会社テレビ東京 ), ©Dentsu Group Inc. ( 株式会社電通グループ ), ©Pierrot Co.,
                Ltd. ( 株式会社ぴえろ ) and ©Tite Kubo ( 久保 帯人 ).
              </p>
              <p className="mt-4">
              ...
              <p className="mt-4">
                ©2024 Valve Corporation. &quot;Steam&quot;, &quot;Steam Deck&quot; and &quot;Steam Logo&quot; are trademarks and/or registered trademarks of Valve Corporation in the United States
