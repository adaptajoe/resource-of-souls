...
const CustomTick = memo(({ x = 0, y = 0, payload, data }: CustomTickProps) => {
...
const transformStatsToRadarData = (stats: Stats): RadarDataPoint[] =>
...
const RadarChartComponent = memo(function RadarChartComponent({ 
  stats, 
  characterName 
}: RadarChartProps) {
