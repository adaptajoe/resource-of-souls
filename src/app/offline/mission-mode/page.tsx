  ...
  return (
    <div className="p-16 space-y-4 text-white">
      <div className="flex flex-row space-x-2">
        ...
        <p>/</p>
        <Link href="/offline/mission-mode" className="text-teal-400 hover:underline">
          Mission Mode
        </Link>
        <p>/</p>
      </div>
      ...
      <p>Information about BLEACH - Rebirth of Souls&apos; Mission Mode will be hosted here when the game launches!</p>
    </div>
  );
}
