  ...
  return (
    <div className="p-4 lg:p-16 space-y-4 text-white">
      <div className="flex flex-row space-x-2">
        ...
        <p>/</p>
        <Link href="/game/online-modes" className="text-teal-400 hover:underline">
          Online Modes
        </Link>
        <p>/</p>
      </div>
      ...
      <p>Information about BLEACH - Rebirth of Souls&apos; Online Modes will be hosted here when the game launches!</p>
    </div>
  );
}
