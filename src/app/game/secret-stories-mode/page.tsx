  ...
  return (
    <div className="p-4 lg:p-16 space-y-4 text-white">
      ...
      <h2 className="text-2xl md:text-3xl font-black border-l-8 border-red-600 pl-4">
        <span className="text-red-600">S</span>ecret Stories Mode
      </h2>
      <p>Information about BLEACH - Rebirth of Souls&apos; Secret Stories Mode will be hosted here when the game launches!</p>
    </div>
  );
}
