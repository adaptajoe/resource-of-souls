  ...
  return (
    <ThemeProvider>
      <div className="text-black dark:text-white">
        <div className="flex bg-gray-200 dark:bg-black flex-col items-center w-full py-2 text-base justify-center px-4 md:text-xl border-b-2 border-b-black dark:border-b-gray-400 font-bebasFont">
          <p className="border-l-8 border-l-red-600 border-r-8 border-r-teal-600 dark:border-r-teal-400 text-center px-4 mb-2">
            We&apos;re currently collecting feedback to submit to Bandai Namco &amp; Tamsoft regarding Rebirth of Souls.{" "}
            <Link className="text-teal-600 dark:text-teal-400 hover:underline" href="https://forms.gle/Rry7YqZdTx5KZukt7">
              You can find the link to the form here
            </Link>
            ..!
          </p>
          <hr className="p-1 my-1 w-full border-black dark:border-gray-400" />
          <p className="border-l-8 border-l-red-600 border-r-8 border-r-teal-600 dark:border-r-teal-400 text-center px-4">
            Our current project is to add animations and data to every character&apos;s move. Please bear with us!
          </p>
        </div>
        <div className="border-b-2 border-black dark:border-gray-400">
        ...
        <div className="p-4 lg:p-16">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="space-y-4">
              ...
              <div className="border-r-8 border-teal-600 dark:border-teal-400 pr-4 space-y-4 px-6">
                ...
                <p>
                  <Link className="px-4 py-2 w-fit font-bebasFont text-xl rounded bg-gray-700 text-white hover:bg-red-600 hover:text-black transition-colors" href={"/characters"}>
            ...
            <div className="flex justify-self-end pr-6">
              <Image
                ...
                width="300"
                alt={""}
                className="max-h-[300px] my-6 lg:mt-0 ml-4 w-fit object-cover object-top-center border-2 border-black dark:border-gray-400 rounded-xl"
                style={{
                  objectFit: "cover",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="flex justify-self-start pr-6">
              <Image
                ...
                width="300"
                alt={""}
                className="max-h-[300px] my-6 lg:mt-0 ml-4 w-[600px] object-cover object-top-center border-2 border-black dark:border-gray-400 rounded-xl"
                style={{
                  objectFit: "cover",
                  objectPosition: "50% 40%",
                  aspectRatio: "2/1",
            ...
            <div className="space-y-4">
              ...
              <div className="border-r-8 border-teal-600 dark:border-teal-400 pr-4 space-y-4 px-6">
                ...
                <p>
                  <Link className="px-4 py-2 w-fit font-bebasFont text-xl rounded bg-gray-700 text-white hover:bg-red-600 hover:text-black transition-colors" href={"/community"}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="space-y-4">
              ...
              <div className="border-r-8 border-teal-600 dark:border-teal-400 pr-4 space-y-4 px-6">
                ...
                <p>
                  <Link className="px-4 py-2 w-fit font-bebasFont text-xl rounded bg-gray-700 text-white hover:bg-red-600 hover:text-black transition-colors" href={"/game"}>
                ...
                <p>
                  <Link className="px-4 py-2 w-fit font-bebasFont text-xl rounded bg-gray-700 text-white hover:bg-red-600 hover:text-black transition-colors" href={"/glossary"}>
                    View the Glossary
                  </Link>
                </p>
              </div>
          ...
          <hr className="lg:mb-16 my-6 border-black dark:border-white" />
          <div className="grid grid-cols-1 text-center">
            <div className="space-y-4">
              <h2 className="text-2xl md:text-3xl xl:text-5xl mb-4">
                <span className="text-red-600">A</span>d free. <span className="text-teal-600 dark:text-teal-400 underline">Forever</span>.
              </h2>
              <p>
                ...
                for donations, and promise to open-source all of our code <span className="text-teal-600 dark:text-teal-400 underline">forever</span>.
              </p>
              <div className="flex flex-row items-baseline justify-center">
                ...
                <h2 className="text-2xl xl:text-3xl text-black dark:text-white ml-2 mt-4">&amp; the rest of the the Resource of Souls Team.</h2>
              </div>
            </div>
          </div>
        </div>
